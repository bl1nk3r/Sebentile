$(document).ready(function(){
	...
	//hide performance rating divs
	$('#perfomanceRDiv1').hide();
	$('#perfomanceRDiv2').hide();
	...
	$('#objMatrixDropdownMenu').change(function() { //inspect the dropdown selection
		value = $(this).val();

		if (value == 'percentage') {
			$('#perfomanceRDiv2').hide(500);
			$('#perfomanceRDiv1').show(500);
		} else if (value == 'time') {
			$('#perfomanceRDiv1').hide(500);
			$('#perfomanceRDiv2').show(500);
